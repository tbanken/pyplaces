...
from . import _utils
from ._errors import InsufficientResponseError, ResponseStatusCodeError
...
def _save_to_cache(
    ...
    if settings.use_cache:
        if not ok:  # pragma: no cover
            ...
            _utils.log(msg, level=lg.WARNING)
        else:
...
def _resolve_host_via_doh(hostname: str) -> str:
    ...
    # if we cannot reach DoH server or resolve host, return hostname itself
        ...
        _utils.log(err_msg, level=lg.ERROR)
        return hostname
